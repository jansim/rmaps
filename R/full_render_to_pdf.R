...
#' @param filename filename of the resulting PDF, generated from name (incl. extension)
#' @param dir directory for the PDF, will be combined with filename to generate final path
#' @param points_to_highlight opt. dataframe of points to highlight needs the columsn long and lat
#'
#' @return nothing
#' @export
#'
full_render_to_pdf <- function (map_data, name, filename = paste0(name, ".pdf"), dir = "renders/", points_to_highlight = NULL) {
